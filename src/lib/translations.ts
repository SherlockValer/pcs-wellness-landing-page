...
export const translations = {
  ...
  hi: {
    ...
    hero: {
      ...
      subtitle:
        "आपके लिए व्यक्तिगत पोषण मार्गदर्शन, स्वस्थ जीवनशैली की आदतें और एक ऐसा समुदाय जो आपकी यात्रा में आपका साथ दे।",
      ctaBook: "मुफ़्त वेलनेस मूल्यांकन बुक करें",
      ctaWhatsapp: "WhatsApp पर संपर्क करें",
      statMembers: "खुश सदस्य",
      statSessions: "वेलनेस सत्र",
      statYears: "वर्षों का अनुभव",
      familyAlt: "खुशहाल और स्वस्थ परिवार",
    },

    about: {
      eyebrow: "PC's वेलनेस क्लब के बारे में",
      heading: "निरोगी जीवन की आपकी यात्रा में साथी",
      p1: "PC's वेलनेस क्लब में हम मानते हैं कि अच्छी सेहत संतुलित पोषण, नियमित गतिविधि, अच्छी आदतों और सकारात्मक सोच से बनती है। हमारा उद्देश्य आपकी यात्रा के हर कदम पर आपको सही जानकारी, प्रेरणा और साथ देना है।",
      script: "बेहतर स्वास्थ्य की ओर साथ मिलकर",
      areasEyebrow: "जिन स्वास्थ्य क्षेत्रों में हम मदद करते हैं",
      areasHeading: "आपका स्वास्थ्य लक्ष्य, हमारा साथ",
      disclaimer:
        "हमारे कार्यक्रम पोषण, स्वस्थ आदतों और जीवनशैली कोचिंग पर केंद्रित हैं। व्यक्तिगत परिणाम अलग-अलग हो सकते हैं। हमारी सेवाओं का उद्देश्य किसी बीमारी का निदान, उपचार, इलाज या रोकथाम करना नहीं है।",
    },

    areas: {
      weight: "वज़न प्रबंधन",
      heart: "हृदय स्वास्थ्य के लिए मार्गदर्शन",
      energy: "ऊर्जा और सक्रिय जीवनशैली",
      child: "बच्चों के पोषण का मार्गदर्शन",
      digestive: "पाचन स्वास्थ्य",
      bone: "हड्डियों और जोड़ों का स्वास्थ्य",
      stress: "तनाव प्रबंधन और मानसिक स्वास्थ्य",
    ...
    bmi: {
      ...
      subtext:
        "अपना BMI जाँचें और स्पीडोमीटर की मदद से संभावित स्वास्थ्य जोखिम के स्तर को आसानी से समझें।",
      enterDetails: "अपनी जानकारी भरें",
      metric: "मीट्रिक",
      imperial: "इम्पीरियल",
      weight: "वज़न",
      heightCm: "ऊँचाई (सेमी)",
      ...
      heightFtPlaceholder: "5",
      heightInPlaceholder: "7",
      calculate: "BMI निकालें",
      resultTitle: "आपका BMI परिणाम",
      bmiLabel: "BMI",
      category: "श्रेणी",
      calcCategory: "अपनी श्रेणी देखने के लिए BMI निकालें",
      calcRisk:
        "यह मीटर आपको संभावित जीवनशैली से जुड़े जोखिम के स्तर को जल्दी समझने में मदद करता है।",
      disclaimer:
        "BMI वयस्कों के लिए एक प्रारंभिक स्वास्थ्य संकेतक है, निदान नहीं। ये उदाहरण केवल सामान्य जानकारी के लिए हैं। एथलीटों, गर्भवती महिलाओं और कुछ विशेष स्वास्थ्य स्थितियों वाले लोगों को अधिक विस्तृत चिकित्सीय मूल्यांकन की आवश्यकता हो सकती है।",

      errors: {
        weight: "कृपया 0 से अधिक सही वज़न दर्ज करें।",
        heightCm: "कृपया सेंटीमीटर में सही ऊँचाई दर्ज करें।",
        heightRange: "यह ऊँचाई सामान्य वयस्क सीमा से बाहर लगती है। कृपया अपनी जानकारी जाँचें।",
        heightFtIn: "कृपया फीट और इंच की सही जानकारी दर्ज करें।",
        inchesRange: "कृपया सही ऊँचाई दर्ज करें। इंच 0 से 11 के बीच होने चाहिए।",
        totalHeight: "कृपया फीट और इंच में सही ऊँचाई दर्ज करें।",
        generic: "इन जानकारियों से BMI नहीं निकाला जा सका। कृपया अपनी जानकारी जाँचें।",
      },

      bands: {
        underweight: {
          label: "कम वज़न",
          risk: "संभावित रूप से जुड़ी स्थितियाँ: आयरन की कमी से होने वाला एनीमिया, विटामिन की कमी और कमज़ोर प्रतिरक्षा।",
        },
        healthy: {
          label: "स्वस्थ",
          risk: "केवल BMI के आधार पर किसी विशेष बीमारी का संकेत नहीं मिलता। अच्छी आदतें और नियमित स्वास्थ्य जाँच जारी रखें।",
        },
        overweight: {
          label: "अधिक वज़न",
          risk: "संभावित रूप से जुड़ी स्थितियाँ: प्रीडायबिटीज, उच्च रक्तचाप, उच्च कोलेस्ट्रॉल और फैटी लिवर।",
        },
        obesity1: {
          label: "मोटापा श्रेणी I",
          risk: "संभावित रूप से जुड़ी स्थितियाँ: टाइप 2 डायबिटीज, स्लीप एपनिया, जोड़ों का दर्द और फैटी लिवर।",
        },
        obesity2: {
          label: "मोटापा श्रेणी II",
          risk: "संभावित रूप से जुड़ी स्थितियाँ: हृदय रोग, स्ट्रोक का बढ़ा हुआ जोखिम, इंसुलिन प्रतिरोध और ऑस्टियोआर्थराइटिस।",
        },
        obesity3: {
          label: "मोटापा श्रेणी III",
          risk: "संभावित रूप से जुड़ी स्थितियाँ: गंभीर स्लीप एपनिया, हृदय और रक्त वाहिकाओं से जुड़ी बीमारियाँ, मेटाबोलिक सिंड्रोम और चलने-फिरने में कठिनाई।",
        },
      },
    },
    ...
    pillars: {
      ...
      exercise: {
        title: "व्यायाम",
        desc: "रोज़ सक्रिय रहें और शरीर को मजबूत बनाएं।",
      },

      nutrition: {
        title: "संतुलित पोषण",
        desc: "अपने शरीर को ज़रूरी पोषक तत्व दें।",
      },

      hydration: {
        title: "पर्याप्त पानी",
        desc: "पानी पिएँ, तरोताज़ा रहें और स्वस्थ रहें।",
      },
      ...
      mindset: {
        title: "सकारात्मक सोच",
        desc: "सकारात्मक सोचें, प्रेरित रहें और खुश रहें।",
      },
    },

    journey: {
      heading: "आपकी वेलनेस यात्रा",
      subtitle: "बेहतर स्वास्थ्य के लिए आसान कदम",

      book: {
        title: "अपना मुफ़्त परामर्श बुक करें",
        desc: "अपने लिए सुविधाजनक समय चुनें।",
      },

      eval: {
        title: "वेलनेस मूल्यांकन",
        desc: "हम आपकी जीवनशैली और लक्ष्यों को समझते हैं।",
      },

      plan: {
        title: "व्यक्तिगत योजना",
        desc: "सिर्फ आपके लिए बनाई गई योजना पाएं।",
      },

      support: {
        title: "निरंतर मार्गदर्शन और प्रगति",
        desc: "सोम – शनि: आपका मार्गदर्शन और आपकी प्रगति पर नज़र।",
      },
    },
    ...
    whyUs: {
      ...
      items: [
        ...
        "अपनापन देने वाला समुदाय",
        "व्यावहारिक दैनिक आदतें",
        "लंबे समय तक टिकने वाले जीवनशैली बदलाव",
        "नियमित फॉलो-अप",
    ...
    testimonials: {
      ...
      disclaimer: "व्यक्तिगत अनुभव और परिणाम अलग-अलग हो सकते हैं।",
    ...
    gallery: {
      heading: "प्रेरणा देने वाले पल",
      alt: "वेलनेस समुदाय",
      showMore: "और तस्वीरें देखें",
      showLess: "कम तस्वीरें दिखाएँ",
    },
    ...
    faq: {
      ...
      a1: "15 वर्ष से अधिक उम्र का कोई भी व्यक्ति जो अपने स्वास्थ्य, ऊर्जा, पोषण या जीवनशैली में सुधार करना चाहता है, हमारे साथ जुड़ सकता है — शुरुआती लोगों का भी स्वागत है।",

      q2: "क्या यह केवल वज़न घटाने के लिए है?",
      a2: "नहीं। हम वज़न घटाने, वज़न बढ़ाने, सक्रिय जीवनशैली, बच्चों के पोषण, तनाव प्रबंधन और बेहतर स्वास्थ्य के लिए मार्गदर्शन देते हैं।",

      q3: "क्या मुझे जिम का अनुभव होना चाहिए?",
      a3: "बिल्कुल नहीं। हमारी योजनाएँ आपके वर्तमान स्तर से शुरू होती हैं और आसान दैनिक आदतों के साथ धीरे-धीरे आगे बढ़ती हैं।",

      q4: "क्या ऑनलाइन सत्र उपलब्ध हैं?",
      a4: "हाँ। आप ऑनलाइन, ऑफलाइन या दोनों तरीकों से जुड़ सकते हैं — जो आपके समय के अनुसार सुविधाजनक हो।",

      q5: "मैं शुरुआत कैसे करूँ?",
      a5: "एक मुफ़्त वेलनेस मूल्यांकन बुक करें। हम आपके लक्ष्यों को समझेंगे और आपके लिए एक व्यक्तिगत योजना साझा करेंगे।",
    },

    booking: {
      ctaHeading: "आपका बेहतर और स्वस्थ भविष्य आज से शुरू होता है!",
      ctaSubtitle: "पहला कदम उठाएँ। अभी अपना मुफ़्त वेलनेस मूल्यांकन बुक करें।",
      ctaBook: "मुफ़्त परामर्श बुक करें",
      ctaWhatsapp: "WhatsApp पर संपर्क करें",

      heading: "अपना मुफ़्त परामर्श बुक करें",
      subtitle: "जानकारी भरें — आपकी बुकिंग की जानकारी के साथ WhatsApp खुल जाएगा।",
      ...
      form: {
        ...
        slots: ["सुबह (8:00 – 10:00 बजे)", "शाम (5:30 – 7:30 बजे)", "ऑनलाइन", "अपनी सुविधानुसार"],

        submit: "WhatsApp से बुक करें",
        helper: "आपकी जानकारी के साथ WhatsApp खुलेगा — बस भेजें दबाएँ।",

        errors: {
          name: "कृपया अपना नाम दर्ज करें।",
          phone: "कृपया 10 अंकों का सही मोबाइल नंबर दर्ज करें।",
          goal: "कृपया अपना लक्ष्य चुनें।",
          slot: "कृपया अपना पसंदीदा समय चुनें।",
        },
      },
    },
    ...
    footer: {
      ...
      disclaimer:
        "अस्वीकरण: PC's वेलनेस क्लब समग्र स्वास्थ्य और कल्याण के लिए वेलनेस शिक्षा, पोषण मार्गदर्शन और जीवनशैली कोचिंग प्रदान करता है। हमारे कार्यक्रम किसी बीमारी का निदान, उपचार, इलाज या रोकथाम करने के लिए नहीं हैं। व्यक्तिगत परिणाम अलग-अलग हो सकते हैं। चिकित्सीय सलाह के लिए अपने डॉक्टर से परामर्श करें।",

      copyright: "© 2026 PC's वेलनेस क्लब। सर्वाधिकार सुरक्षित।",
    },
  ...
  mr: {
    ...
    hero: {
      ...
      subtitle:
        "तुमच्यासाठी वैयक्तिक पोषण मार्गदर्शन, निरोगी जीवनशैलीच्या सवयी आणि तुमच्या प्रवासात साथ देणारा समुदाय.",
      ctaBook: "मोफत वेलनेस मूल्यांकन बुक करा",
      ctaWhatsapp: "WhatsApp वर संपर्क करा",
      statMembers: "आनंदी सदस्य",
      statSessions: "वेलनेस सत्रे",
      statYears: "वर्षांचा अनुभव",
      familyAlt: "आनंदी आणि निरोगी कुटुंब",
    },

    about: {
      eyebrow: "PC's वेलनेस क्लबबद्दल",
      heading: "निरोगी जीवनाच्या प्रवासात तुमचा साथीदार",
      p1: "PC's वेलनेस क्लबमध्ये आम्ही मानतो की चांगले आरोग्य संतुलित पोषण, नियमित हालचाल, चांगल्या सवयी आणि सकारात्मक विचारांनी घडते. तुमच्या प्रवासातील प्रत्येक टप्प्यावर योग्य माहिती, प्रेरणा आणि साथ देणे हे आमचे उद्दिष्ट आहे.",
      script: "चांगल्या आरोग्यासाठी एकत्र",
      areasEyebrow: "ज्या आरोग्य क्षेत्रांत आम्ही मार्गदर्शन करतो",
      areasHeading: "तुमचे आरोग्य ध्येय, आमची साथ",
      disclaimer:
        "आमचे कार्यक्रम पोषण, निरोगी सवयी आणि जीवनशैली मार्गदर्शनावर केंद्रित आहेत. वैयक्तिक परिणाम वेगवेगळे असू शकतात. आमच्या सेवांचा उद्देश कोणत्याही आजाराचे निदान, उपचार, बरे करणे किंवा प्रतिबंध करणे नाही.",
    },

    areas: {
      weight: "वजन व्यवस्थापन",
      heart: "हृदयाच्या आरोग्यासाठी मार्गदर्शन",
      energy: "ऊर्जा आणि सक्रिय जीवनशैली",
      child: "मुलांच्या पोषणासाठी मार्गदर्शन",
      digestive: "पचनाचे आरोग्य",
      bone: "हाडे आणि सांध्यांचे आरोग्य",
      stress: "तणाव व्यवस्थापन आणि मानसिक स्वास्थ्य",
    ...
    bmi: {
      ...
      subtext:
        "तुमचा BMI तपासा आणि स्पीडोमीटरच्या मदतीने संभाव्य आरोग्य जोखमीची पातळी सहज समजून घ्या.",
      enterDetails: "तुमची माहिती भरा",
      metric: "मेट्रिक",
      imperial: "इम्पीरियल",
      weight: "वजन",
      heightCm: "उंची (सेमी)",
      ...
      heightInPlaceholder: "7",
      calculate: "BMI काढा",
      resultTitle: "तुमचा BMI निकाल",
      bmiLabel: "BMI",
      category: "श्रेणी",
      calcCategory: "तुमची श्रेणी पाहण्यासाठी BMI काढा",
      calcRisk:
        "हे मीटर तुम्हाला जीवनशैलीशी संबंधित संभाव्य आरोग्य जोखमीची पातळी पटकन समजून घेण्यास मदत करते.",
      disclaimer:
        "BMI हे प्रौढांसाठी आरोग्य तपासणीचे एक प्रारंभिक सूचक आहे; ते निदान नाही. ही उदाहरणे केवळ सामान्य माहितीसाठी आहेत. खेळाडू, गर्भवती महिला आणि काही विशिष्ट वैद्यकीय स्थिती असलेल्या व्यक्तींना अधिक सविस्तर वैद्यकीय तपासणीची आवश्यकता असू शकते.",

      errors: {
        weight: "कृपया 0 पेक्षा जास्त योग्य वजन भरा.",
        heightCm: "कृपया सेंटीमीटरमध्ये योग्य उंची भरा.",
        heightRange: "ही उंची प्रौढांसाठी अपेक्षित मर्यादेबाहेर दिसते. कृपया तुमची माहिती तपासा.",
        heightFtIn: "कृपया फूट आणि इंचाची योग्य माहिती भरा.",
        inchesRange: "कृपया उंचीची योग्य माहिती भरा. इंच 0 ते 11 दरम्यान असावेत.",
        totalHeight: "कृपया फूट आणि इंचमध्ये योग्य उंची भरा.",
        generic: "या माहितीतून BMI काढता आला नाही. कृपया तुमची माहिती तपासा.",
      },

      bands: {
        underweight: {
          label: "कमी वजन",
          risk: "संभाव्य संबंधित स्थिती: लोहाच्या कमतरतेमुळे होणारा अॅनिमिया, जीवनसत्त्वांची कमतरता आणि कमी प्रतिकारशक्ती.",
        },
        healthy: {
          label: "निरोगी",
          risk: "केवळ BMI वरून कोणत्याही विशिष्ट आजाराचा संकेत मिळत नाही. चांगल्या सवयी आणि नियमित आरोग्य तपासणी सुरू ठेवा.",
        },
        overweight: {
          label: "जास्त वजन",
        ...
        obesity2: {
          ...
          risk: "संभाव्य संबंधित स्थिती: हृदयरोग, स्ट्रोकचा वाढलेला धोका, इन्सुलिन प्रतिरोध आणि ऑस्टिओआर्थरायटिस.",
        },
        obesity3: {
          label: "लठ्ठपणा श्रेणी III",
          risk: "संभाव्य संबंधित स्थिती: गंभीर स्लीप एपनिया, हृदय व रक्तवाहिन्यांशी संबंधित आजार, मेटाबॉलिक सिंड्रोम आणि हालचालींमध्ये अडचणी.",
        },
      },
    },
    ...
    pillars: {
      ...
      exercise: {
        title: "व्यायाम",
        desc: "दररोज सक्रिय राहा आणि शरीर मजबूत बनवा.",
      },

      nutrition: {
        title: "संतुलित पोषण",
        desc: "शरीराला आवश्यक पोषक घटक द्या.",
      },

      hydration: {
        title: "पुरेसे पाणी",
        desc: "पाणी प्या, ताजेतवाने राहा आणि निरोगी राहा.",
      },
      ...
      mindset: {
        ...
        desc: "सकारात्मक विचार करा, प्रेरित राहा आणि आनंदी राहा.",
      },
    },

    journey: {
      heading: "तुमचा वेलनेस प्रवास",
      subtitle: "निरोगी जीवनासाठी सोपी पावले",

      book: {
        title: "तुमचा मोफत सल्ला बुक करा",
        desc: "तुमच्यासाठी सोयीची वेळ निवडा.",
      },

      eval: {
        title: "वेलनेस मूल्यांकन",
        desc: "आम्ही तुमची जीवनशैली आणि ध्येये समजून घेतो.",
      },
      ...
      support: {
        title: "सतत मार्गदर्शन आणि प्रगती",
        desc: "सोम – शनि: सतत मार्गदर्शन आणि तुमच्या प्रगतीचा आढावा.",
      },
    },
    ...
    whyUs: {
      ...
      items: [
        "वैयक्तिक मार्गदर्शन",
        "आपलेपणा देणारा समुदाय",
        "व्यावहारिक दैनंदिन सवयी",
        "दीर्घकाळ टिकणारे जीवनशैलीतील बदल",
        "नियमित फॉलो-अप",
    ...
    testimonials: {
      ...
      disclaimer: "वैयक्तिक अनुभव आणि परिणाम वेगवेगळे असू शकतात.",
    ...
    faq: {
      ...
      a1: "15 वर्षांपेक्षा जास्त वयाची, आरोग्य, ऊर्जा, पोषण किंवा जीवनशैली सुधारण्याची इच्छा असलेली कोणतीही व्यक्ती आमच्याशी जोडू शकते — नवशिक्यांचेही स्वागत आहे.",

      q2: "हे फक्त वजन कमी करण्यासाठी आहे का?",
      a2: "नाही. आम्ही वजन कमी करणे, वजन वाढवणे, सक्रिय जीवनशैली, मुलांचे पोषण, तणाव व्यवस्थापन आणि एकूणच निरोगी जीवनशैलीसाठी मार्गदर्शन करतो.",

      q3: "मला जिमचा अनुभव असणे आवश्यक आहे का?",
      a3: "अजिबात नाही. आमच्या योजना तुमच्या सध्याच्या पातळीपासून सुरू होतात आणि सोप्या दैनंदिन सवयींसह हळूहळू पुढे जातात.",

      q4: "ऑनलाइन सत्रे उपलब्ध आहेत का?",
      a4: "होय. तुम्ही ऑनलाइन, ऑफलाइन किंवा दोन्ही प्रकारे आमच्याशी जोडले जाऊ शकता — तुमच्या वेळेनुसार जे सोयीचे असेल ते निवडा.",

      q5: "मी सुरुवात कशी करू?",
      a5: "मोफत वेलनेस मूल्यांकन बुक करा. आम्ही तुमची ध्येये समजून घेऊ आणि तुमच्यासाठी वैयक्तिक योजना तयार करू.",
    },

    booking: {
      ctaHeading: "तुमचे अधिक निरोगी भविष्य आजपासून सुरू होते!",
      ...
      subtitle: "माहिती भरा — तुमच्या बुकिंगच्या माहितीसह WhatsApp उघडेल.",
      ...
      form: {
        ...
        goals: ["वजन कमी करणे", "वजन वाढवणे", "पोषण", "फिटनेस", "सामान्य वेलनेस"],

        slots: ["सकाळी (8:00 – 10:00)", "संध्याकाळी (5:30 – 7:30)", "ऑनलाइन", "तुमच्या सोयीनुसार"],

        submit: "WhatsApp वरून बुक करा",
        helper: "तुमच्या माहितीसह WhatsApp उघडेल — फक्त पाठवा दाबा.",

        errors: {
          name: "कृपया तुमचे नाव भरा.",
          phone: "कृपया 10 अंकी योग्य मोबाइल क्रमांक भरा.",
          goal: "कृपया तुमचे ध्येय निवडा.",
          slot: "कृपया तुमची सोयीची वेळ निवडा.",
        },
      },
    },
    ...
    footer: {
      ...
      disclaimer:
        "अस्वीकरण: PC's वेलनेस क्लब एकूण आरोग्य आणि कल्याणासाठी वेलनेस शिक्षण, पोषण मार्गदर्शन आणि जीवनशैली मार्गदर्शन प्रदान करते. आमच्या कार्यक्रमांचा उद्देश कोणत्याही आजाराचे निदान, उपचार, बरे करणे किंवा प्रतिबंध करणे नाही. वैयक्तिक परिणाम वेगवेगळे असू शकतात. वैद्यकीय सल्ल्यासाठी तुमच्या डॉक्टरांचा सल्ला घ्या.",
